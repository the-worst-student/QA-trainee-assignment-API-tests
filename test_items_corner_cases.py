...
def test_create_same_payload_twice_returns_different_item_ids(api_client: ApiClient) -> None:
...
def test_repeated_get_statistics_by_item_id_returns_stable_data(api_client: ApiClient) -> None:
    payload = build_item_payload()
    create_response = api_client.create_item(payload)
    ...
    second_statistic = extract_statistic_from_response(second_statistics_response.json())
